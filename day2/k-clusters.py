# -*- coding: utf-8 -*-
"""
Created on Tue Nov  5 18:10:06 2019
...
dataset = pd.read_csv('digitalmarketing.csv')
...
# init = method k means ++ initialisation
from sklearn.cluster import KMeans
wcss = []
for i in range(1, 11):
   kmeans = KMeans(n_clusters = i, init = 'k-means++', random_state = 42)
   # fits the algorithm to your data
   kmeans.fit(X)
...
#fit predict method will output the cluster to which the clients belongs and this will be a vector
